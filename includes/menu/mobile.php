...
<div class="menusection">WOD</div>
	<ul>
		...
		<li<?php if($Module == 'benchmark'){?> class="active"<?php } ?>><img id="menuselect" alt="Menu" <?php echo $RENDER->NewImage('menu/bench.png');?> src="<?php echo IMAGE_RENDER_PATH;?>menu/bench.png"/><a href="" onclick="OpenThisPage('?module=benchmark');" class="contentLink">Benchmarks</a></li>
...
<div class="menusection">FEATURES</div>
	<ul>
		<li<?php if($Module == 'nutrition'){?> class="active"<?php } ?>><img id="menuselect" alt="Menu" <?php echo $RENDER->NewImage('menu/nutrition.png');?> src="<?php echo IMAGE_RENDER_PATH;?>menu/nutrition.png"/>Nutrition</li>
		...
		<li<?php if($Module == 'challenge'){?> class="active"<?php } ?>><img id="menuselect" alt="Menu" <?php echo $RENDER->NewImage('menu/challenge.png');?> src="<?php echo IMAGE_RENDER_PATH;?>menu/challenge.png"/>Challenges</li>
...
<div class="menusection">MY GYM</div>
	<ul>
		...
		<li<?php if($Module == 'book'){?> class="active"<?php } ?>><img id="menuselect" alt="Menu" <?php echo $RENDER->NewImage('menu/schedule.png');?> src="<?php echo IMAGE_RENDER_PATH;?>menu/schedule.png"/>Schedule</li>
		<li<?php if($Module == 'locator'){?> class="active"<?php } ?>><img id="menuselect" alt="Menu" <?php echo $RENDER->NewImage('menu/affiliate.png');?> src="<?php echo IMAGE_RENDER_PATH;?>menu/affiliate.png"/><a href="" onclick="OpenThisPage('?module=locator');" class="contentLink">Affiliates</a></li>
                <li<?php if($Module == 'about'){?> class="active"<?php } ?>><img id="menuselect" alt="Menu" <?php echo $RENDER->NewImage('menu/aboutUs.png');?> src="<?php echo IMAGE_RENDER_PATH;?>menu/aboutUs.png"/><a href="" onclick="OpenThisPage('?module=about');" class="contentLink">About Us</a></li>
	</ul>
