...
class utility extends utility_base
{
	...
	public static function draw_upload_form()
	{
        ...
        public static function include_stylesheet($styleSheetName = "style.css", $width = '0', $ratio = 1)
	{
		//need to get phone capabilities here & change accordingly
		$data = file_get_contents($styleSheetName);
		$ret = str_replace('~|~width~|~', $width, $data);
