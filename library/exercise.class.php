<?php
/********************************************************
Class to get exercise details
Copyright Be-Mobile

Created By   : Darren Hart
Created Date : 20 February 2012

Last Modified Date: 20 February 2012
...
class Exercise
{
	...
	function getExercise($id)
	{
		...
		$Sql = 'SELECT E.Exercise,
			...
			JOIN SkillsLevel1 SK1 ON SK1.recid = S.LevelOneId
			JOIN SkillsLevel2 SK2 ON SK2.recid = S.LevelTwoId
			JOIN SkillsLevel3 SK3 ON SK3.recid = S.LevelThreeId
			JOIN SkillsLevel4 SK4 ON SK4.recid = S.LevelFourId
			WHERE S.ExerciseId = '.$id.'
			GROUP BY S.ExerciseId';
		$Result = mysql_query($Sql);		
		return new ExerciseObject(mysql_fetch_assoc($Result));
	}
}
