...
function getInputFields(exerciseId){
    var Html='';
    if(document.getElementById('exercise_'+exerciseId+'_input').innerHTML == ''){
    var ThisRoutineNumber = document.getElementById('RoutineCounter').value;
    ...
    $.each(json, function() {  
        if(this.Attribute == 'Height')        
            Html+='<input type="text" name="'+ThisRoutineNumber+'_'+exerciseId+'_Height" value="" style="float:left;width:75px" placeholder="Height"/>';
        
        if(this.Attribute == 'Rounds')        
            Html+='<input type="text" name="'+ThisRoutineNumber+'_'+exerciseId+'_Rounds" value="" style="float:left;width:75px" placeholder="Rounds"/>';
        ...
        if(this.Attribute == 'Distance')        
            Html+='<input type="text" name="'+ThisRoutineNumber+'_'+exerciseId+'_Distance" value="" style="float:left;width:75px" placeholder="Distance"/>';
    });
