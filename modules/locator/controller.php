...
class LocatorController extends Controller {
	...
	function __construct() {
		...
		/*
		 * if (isset ( $_REQUEST ['Id'] )) { $this->getMap ($_REQUEST ['Id']); }
		 */
	}
	function getDriveInstructions() {
		$Model = new LocatorModel ();
		$Affiliate = $Model->getAffiliate ( $_REQUEST ["getDriveInstructions"] );
		...
		// $html = '<button
		// onclick="closeDriveInstructions('.$Affiliate->AffiliateId .');">Close
		// Driving Instructions</button>';
		// $html .= '<br/>';
		$html .= $str;
		return $html;
	}
	function getMap() {
		...
		// $html .= '<button onclick="closeMap('.$Affiliate->AffiliateId
		// .');">Close Map</button>';
...
var polyline = new google.maps.Polyline({
	...
	function Output() {
		...
		if (isset ( $_REQUEST ["driveInstructions"] )) {
			$html = $this->getDriveInstructions ();
