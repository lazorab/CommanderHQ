...
else
{
	...
	$HeaderSlice = $RENDER->Image('header_slice.png', $this->Device->GetScreenWidth());
	...
	$categoryhtml.='<div data-role="page" id="categories">
		<div class="header" data-role="header" style="background-image:url('.$HeaderSlice.');repeat-x">
	...
	//$html.='<br/>';
	$bmwhtml.='</div><div class="footer" data-role="footer" style="background-color:#0d3d5f;">
		Terms &amp; Conditions | About | Contact
	</div><!-- /footer --></div>';
	
	}
	$html=''.$categoryhtml.'</div><div class="footer" data-role="footer" style="background-color:#0d3d5f;">
		Terms &amp; Conditions | About | Contact
